		...
		<div class="container">
			...
			<div class="wrap-show-advance-info-box style-1 has-countdown">
				...
				<div class="wrap-products slide-carousel owl-carousel style-nav-1 equal-container " data-items="5" data-loop="false" data-nav="true" data-dots="false" data-responsive='{"0":{"items":"1"},"480":{"items":"2"},"768":{"items":"3"},"992":{"items":"4"},"1200":{"items":"5"}}'>
					@foreach ($sproducts as $sitem )
					<div class="product product-style-2 equal-elem ">
						<div class="product-thumnail">
							<a href="{{ route('product.detail',['slug' => $sitem->slug]) }}" title="{{ $sitem->name }}">
								<figure><img src="{{ asset('assets/images/products/'.$sitem->image)}}" width="800" height="800" alt="T-Shirt Raw Hem Organic Boro Constrast Denim"></figure>
							</a>
						...
						<div class="product-info">
							<a href="{{ route('product.detail',['slug' => $sitem->slug]) }}" class="product-name"><span>{{ $sitem->name }}</span></a>
							<div class="wrap-price"><ins><p class="product-price">${{ $sitem->sale_price }}</p></ins> <del><p class="product-price">${{ $sitem->regular_price }}</p></del></div>
