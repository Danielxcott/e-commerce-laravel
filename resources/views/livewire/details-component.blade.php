                                                ...
                                                <div id="comment-20" class="comment_container"> 
                                                    ...
                                                    <div class="comment-text">
                                                        <div class="star-rating">
                                                            <span class="width-{{ $orderItem->review->rating * 20 }}-percent">Rated</span>
                                                        </div>
                                                        <p class="meta"> 
                                                            <strong class="woocommerce-review__author">{{ $orderItem->order->user->name }}</strong> 
                                                            <span class="woocommerce-review__dash">–</span>
                                                            <time class="woocommerce-review__published-date" datetime="2008-02-14 20:00" >{{ $orderItem->review->created_at->format("D , d M Y ") }}</time>
                                                        </p>
                            ...
                            <li class="product-item">
                                <div class="product product-widget-style">
                                    <div class="thumbnnail">
                                        <a href="{{ route('product.detail',$popular_product->slug) }}" title="Radiant-360 R6 Wireless Omnidirectional Speaker [White]">
                        ...
                        <div class="products slide-carousel owl-carousel style-nav-1 equal-container" data-items="5" data-loop="false" data-nav="true" data-dots="false" data-responsive='{"0":{"items":"1"},"480":{"items":"2"},"768":{"items":"3"},"992":{"items":"3"},"1200":{"items":"5"}}' >
                            ...
                            <div class="product product-style-2 equal-elem ">
                                <div class="product-thumnail">
                                    <a href="{{ route('product.detail',$relate_product->slug) }}" title="T-Shirt Raw Hem Organic Boro Constrast Denim">
                                        <figure><img src="{{ asset('assets/images/products/'.$relate_product->image)}}" width="214" height="214" alt="{{ $relate_product->name }}"></figure>
                                    </a>
                                ...
                                <div class="product-info">
                                    <a href="{{ route('product.detail',$relate_product->slug) }}" class="product-name"><span>{{ $relate_product->name }}</span></a>
                                    <div class="wrap-price"><span class="product-price">${{ $relate_product->regular_price }}</span></div>
                                </div>
                            </div>
                            @endforeach
